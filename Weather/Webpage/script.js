var UIcontroller=(function(){
    ...
    var cards=(data)=>{
        ...
        html = '<div class="weatherCard grow" id="%card%"><h1>%day%</h1><br><p>Temp: %temp% <br><br>Max Temp: %MaxTemp%<br><br>Min Temp: %MinTemp%<br><br>Humidity: %Humidity%<br><br></p></div>';
        
        newHtml1= html.replace('%day%', 'Yestarday Weather');
        ...
        newHtml2= html.replace('%day%','Today Weather');
        ...
        newHtml3 = html.replace('%day%', 'Tomorrow Weather');
        ...
        newHtml4 = html.replace('%day%', 'DayTomorrow Weather');
